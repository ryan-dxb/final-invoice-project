...
interface DataTableSelectFilterDemoProps<TData, TValue> {
...
const DataTableSelectFilterDemo: FC<
  DataTableSelectFilterDemoProps<any, any>
...
export default DataTableSelectFilterDemo;
